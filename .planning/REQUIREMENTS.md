...
- [x] **INFER-03**: LiteLLM Proxy Application removed after privacy router verified end-to-end
- [x] **INFER-04**: `nemoclaw` namespace fully cleaned up (all LiteLLM resources, SealedSecret)
